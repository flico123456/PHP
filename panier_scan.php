...
// Connecting to MySQL Database.
 ...
 $S_Value = $obj['sku_produit'];

 
 // Creating SQL query and insert the record into MySQL database table.
 $Sql_Query = "insert into appli_panier (nom_phone,value_produit) values ('$S_Name', (SELECT value_produit FROM produit_via_depot WHERE sku_produit = $S_Value))";
